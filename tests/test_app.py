...
def test_config_loaded_from_dotenv():
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".env", delete=False) as f:
        f.write(
            "SECRET_KEY=dotenv-test-key-1234567890-dotenv-test-key-1234567890-extra-chars\n"
        )
    ...
    try:
        ...
        assert (
            ...
            == "dotenv-test-key-1234567890-dotenv-test-key-1234567890-extra-chars"
        )
        assert app.config["DEBUG"] is True
    finally:
        # Clean up
...
def test_500_handler_passes_error_to_template():
    ...
    app.config["PROPAGATE_EXCEPTIONS"] = False  # Ensure exceptions are handled by error handlers
